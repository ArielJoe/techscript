...
@section('content')
    <div class="lg:flex lg:items-center lg:justify-between mb-8 mx-3 md:mx-4 mt-2">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold text-gray-900 sm:truncate sm:text-3xl sm:pb-1 sm:tracking-tight">Surat Pengantar Tugas Mata Kuliah (SPTMK)</h2>
        </div>
                        ...
                        <tbody>
                            @foreach ($letters as $letter)
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-4 py-3">
                                        <button data-modal-target="mahasiswa-sptmk-modal-{{ $letter->id }}" data-modal-toggle="mahasiswa-sptmk-modal-{{ $letter->id }}" type="button"
