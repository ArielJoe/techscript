...
=======
                    ...
                    {{-- <a href="{{ route('mahasiswa.skma.index') }}"> --}}
                        <a href="{{ route('mahasiswa.skma.index') }}" class="cursor-pointer inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 ml-1 text-sm font-medium text-center border border-gray-300 text-gray-900 rounded-lg hover:bg-gray-100">
                            Batalkan
                        </a>
