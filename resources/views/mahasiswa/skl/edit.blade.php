...
@section('content')
    <section>
        <div class="py-4 px-4 mx-auto max-w-2xl lg:py-4">
            ...
            <form action="{{ route('mahasiswa.skl.update', $letter->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input id="datepicker" type="text" name="graduation_date"
                                value="{{ old('graduation_date', $letter->graduation_date) }}"
                                class="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full ps-10 p-2.5 focus:outline-none focus:ring-teal-cyan focus:border-teal-cyan"
