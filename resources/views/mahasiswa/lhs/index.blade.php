...
<<<<<<< HEAD
            <h2 class="text-2xl font-bold text-gray-900 sm:truncate sm:text-3xl sm:pb-1 sm:tracking-tight">Laporan Hasil
                Studi (LHS)</h2>
=======
            <h2 class="text-2xl font-bold text-gray-900 sm:truncate sm:text-3xl sm:pb-1 sm:tracking-tight">Laporan Hasil Studi (LHS)</h2>
>>>>>>> e8489abcd84da377b1d0da4713bff0d153315699
        </div>
        <div class="mt-5 flex lg:mt-0 lg:ml-4">
            <span class="sm:ml-3">
                <a href="{{ route('mahasiswa.lhs.create') }}">
                    <button type="button"
                ...
                <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                    <div
                        ...
                        <div class="w-full md:w-64">
                            <form method="GET" action="{{ route('mahasiswa.lhs.index') }}" class="flex items-center">
                                    ...
                                    iMac 27"</th> --}}
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex gap-2">
                                                ...
                                                <a href="{{ route('mahasiswa.lhs.edit', $letter->id) }}">
                                                    <button type="button"
                                                ...
                                                <form id="delete-form-{{ $encodedId }}"
                                                    action="{{ route('mahasiswa.lhs.destroy', ['lhs' => urlencode($letter->id)]) }}"
                        ...
                        <tbody>
                            @foreach ($letters as $letter)
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-4 py-3">
                                        <button data-modal-target="mahasiswa-lhs-modal-{{ $letter->id }}" data-modal-toggle="mahasiswa-lhs-modal-{{ $letter->id }}" type="button"
