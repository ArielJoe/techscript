...
@section('content')
    <section>
        <div class="py-4 px-4 mx-auto max-w-2xl lg:py-4">
            <h1 class="mb-6 text-2xl text-center font-bold text-gray-900">Edit Laporan Hasil Studi</h1>
            <form action="{{ route('mahasiswa.lhs.update', $letter->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <textarea name="purpose"
                            class="bg-gray-50 border min-h-25 max-h-25 text-gray-900 text-sm rounded-lg block w-full p-2.5 @error('purpose') border-red-500 @enderror"
